...
Shader "HDRP/Lit (Nature Renderer)"
{
    Properties
    {
    ...
    SubShader
    {
        ...
        Tags{ "RenderPipeline"="HDRenderPipeline" "RenderType" = "HDLitShader"  "NatureRendererInstancing"="True" 
}

        Pass
        {
            Name "ScenePickingPass"
            Tags { "LightMode" = "Picking"  "NatureRendererInstancing"="True" }
        ...
        Pass
        {
            ...
            Tags { "LightMode" = "SceneSelectionPass"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "GBuffer"
            Tags { "LightMode" = "GBuffer"  "NatureRendererInstancing"="True" } // This will be only for opaque object based on the RenderQueue index
        ...
        {
            Name "MotionVectors"
            Tags{ "LightMode" = "MotionVectors"  "NatureRendererInstancing"="True" } // Caution, this need to be call like this to setup the correct parameters by C++ (legacy Unity)
        ...
        Pass
        {
            ...
            Tags{ "LightMode" = "TransparentDepthPrepass"  "NatureRendererInstancing"="True" }
        ...
        Pass
        {
            ...
            Tags { "LightMode" = "TransparentBackface"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "Forward"
            Tags { "LightMode" = "Forward"  "NatureRendererInstancing"="True" } // This will be only for transparent object based on the RenderQueue index
        ...
        Pass
        {
            ...
            Tags { "LightMode" = "TransparentDepthPostpass"  "NatureRendererInstancing"="True" }
        ...
        Pass
        {
            ...
            Tags{ "LightMode" = "RayTracingPrepass"  "NatureRendererInstancing"="True" }
        ...
        Pass
        {
            ...
            Tags{ "LightMode" = "FullScreenDebug"  "NatureRendererInstancing"="True" }
    ...
    SubShader
    {
        Tags{ "RenderPipeline"="HDRenderPipeline"  "NatureRendererInstancing"="True" }
        Pass
        {
            Name "IndirectDXR"
            Tags{ "LightMode" = "IndirectDXR"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "ForwardDXR"
            Tags{ "LightMode" = "ForwardDXR"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "GBufferDXR"
            Tags{ "LightMode" = "GBufferDXR"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "VisibilityDXR"
            Tags{ "LightMode" = "VisibilityDXR"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "SubSurfaceDXR"
            Tags{ "LightMode" = "SubSurfaceDXR"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "DebugDXR"
            Tags{ "LightMode" = "DebugDXR"  "NatureRendererInstancing"="True" }
        ...
        {
            Name "PathTracingDXR"
            Tags{ "LightMode" = "PathTracingDXR"  "NatureRendererInstancing"="True" }
